/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1543a547f570e88f08b98173fcc79521)
// Runtime types generated with workerd@1.20251118.0 2025-07-18 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "ImageTransformerContainer";
  }
  interface Env {
    IMAGE_TRANSFORMER_URL: "http://localhost:8090";
    ALLOWED_ORIGINS: string;
    IMAGE_TRANSFORMER: DurableObjectNamespace<import("./src/index").ImageTransformerContainer>;
    CARD_IMAGES: R2Bucket;
    BACKEND_API: Service /* entrypoint AssetService from trading-card-simulator-api */;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<Pick<Cloudflare.Env, "IMAGE_TRANSFORMER_URL" | "ALLOWED_ORIGINS">> {}
}
